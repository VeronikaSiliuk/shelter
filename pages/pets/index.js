...
const popupPets = document.querySelector(".popup__pets");// строка с породой
const popupText = document.querySelector(".popup__text");// описание 
const age = document.querySelector(".age");// список возраст
const inoculations = document.querySelector(".inoculations");// список inoculations
const diseases = document.querySelector(".diseases");// список diseases
const parasites = document.querySelector(".parasites");// список parasites
